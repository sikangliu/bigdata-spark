package com.lsk.bigdata.spark.streaming
    ...
    def main(args: Array[String]): Unit = {
        ...
        reduceDS.foreachRDD(
            rdd => {
                ...
                // 输出文件
                val out = new PrintWriter(new FileWriter(new File("D:\\mineworkspace\\idea\\classes\\lsk-classes\\datas\\adclick\\adclick.json")))
